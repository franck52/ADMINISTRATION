	...
	<?php
		...
		$requete="SELECT * FROM votant WHERE idElect='$lastElt' order by Nomvotant";
            	...
            	<form method="POST" action="recherche_par_centre.php" class="form-inline navbar-form pull-right">
                     <div class="form-group">
                        ...
                        <select class="form-control" name="centr" id="centr">
                              ...
                              <option value="20WILLI">WILLIAMSVILLE</option>
		...
		<table class="table table-striped table-bordered">
			...
			<tr>
				...
				<td><?php echo $votant['annee_elect'] ?> </td>
					...
					<?php if($_SESSION['user']['roles']=='Directeur'){  ?>
								<td> 
									<a href="page_valider.php?id=<?php echo $votant['numvotan']?>" 
									...
									<a 
										...
										href="delete_electeur.php?id=<?php echo $votant['numvotan']?>" 
