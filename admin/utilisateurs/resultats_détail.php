							...
							<ul class="nav nav--header nav--header-1">
								<li class="nav__item nav__item--home">
									...
									<ul class="nav nav--header nav--header-2">
										...
										<li class="nav__item">
											<a class="nav__link" href="#0"> Adjamé :<?php $val= total_secteur(2021, "ADJAME", 1, $lastElt); echo $val;?> voix </a>
										</li>
										<li class="nav__item">
									...
									<ul class="nav nav--header nav--header-2">
										...
										<li class="nav__item">
											<a class="nav__link" href="#0"> Adjamé :<?php $val= total_secteur(2021, "ADJAME", 2, $lastElt); echo $val;?> voix </a>
										</li>
										<li class="nav__item">
									...
									<ul class="nav nav--header nav--header-2">
										...
										<li class="nav__item">
											<a class="nav__link" href="#0"> Adjamé :<?php $val= total_secteur(2021, "ADJAME", 3, $lastElt); echo $val;?> voix </a>
										</li>
										<li class="nav__item">
									...
									<ul class="nav nav--header nav--header-2">
										...
										<li class="nav__item">
											<a class="nav__link" href="#0"> Adjamé :<?php $val= total_secteur(2021, "ADJAME", 4, $lastElt); echo $val;?> voix </a>
										</li>
										<li class="nav__item">
					...
					<main class="layout__main">
						<section class='hero'>
							<div class="hero-block hero-block--header">
								...
								<p class="hero-text">Ici, vous avez la possiblité de suivre l'évolution du dépouillement par candidat. Un peu comment le resumé des resultats obtenus par candidat</p>
							</div>
						</section>
					</main>
				</div>
