...
<?php
	...
	$requete="select * from administration where id_admin=$id";
		...
		<div class="container col-md-6 col-md-offset-3">
			...
			<div class="panel panel-danger">
				...
				<div class="panel-body">
					...
					<input type="hidden" name="id_udser" value="<?php echo $utilisateur['id_admin'] ?>">
						...
						<?php if($_SESSION['user']['roles']=="Directeur"){?>
							<div class="form-group">
								...
								<select class="form-control" name="role">
									...
									<option <?php if($utilisateur['roles']== 'Secrétaire') 
													echo 'selected'  
											?>> 
										Secrétaire 
									</option>
									
									<option <?php if($utilisateur['roles']== 'Directeur') 
													echo 'selected'  
											?>> 
										Directeur 
									</option>
